...
<?php
$scriptsVersion = @filemtime(__DIR__ . '/../../assets/js/scripts.js') ?: '1';
$funcionesVersion = @filemtime(__DIR__ . '/../../assets/js/funciones.js') ?: '1';
?>
<script src="../assets/js/jquery-3.6.0.min.js" crossorigin="anonymous"></script>
<script src="../assets/js/bootstrap.bundle.min.js" crossorigin="anonymous"></script>
<script src="../assets/js/scripts.js?v=<?php echo urlencode((string) $scriptsVersion); ?>"></script>
...
<script src="../assets/js/funciones.js?v=<?php echo urlencode((string) $funcionesVersion); ?>"></script>
